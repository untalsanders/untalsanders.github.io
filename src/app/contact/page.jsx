    ...
    <div className={styles.ContactPage}>
        <div className={`container ${styles.ContactPage__Content}`}>
            <div className={styles.ContactPage__Header}>
                ...
                <h3>Get in touch</h3>
                <p>
                    I'm currently avaliable to take on new projects, so feel free to send me a message about anything that
                    you want to run past me. You can contact anytime at 24/7.
                </p>
